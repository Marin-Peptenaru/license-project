...
func (m *mgmTopicRepository) FindByAdmin(ctx context.Context, admin string, topics *[]domain.Topic) error {

	err := mgm.Coll(&domain.Topic{}).SimpleFindWithCtx(ctx, topics, bson.M{"admin": admin})
...
func (m *mgmTopicRepository) FindByTitleMatch(ctx context.Context, titleMatch string, topics *[]domain.Topic) error {
